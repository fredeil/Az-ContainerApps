...
public static class DaprHelpers
{
    ...
    public static IHttpClientBuilder AddDaprGrpcClient<TClient>(this IServiceCollection services, string appId, string? daprEndpoint = null, string? daprApiToken = null) where TClient : class
    {
